...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/PHFWHDHD/Files_BLACK/main/File_Bot/commands.lua") 
...
BLACK_Msg = 'زعيم التفاعل' 
elseif msgs < 4500 then 
BLACK_Msg = 'مدمن تفاعل' 
elseif msgs < 5000 then 
BLACK_Msg = 'جامد ف التفاعل' 
elseif msgs < 7000 then 
BLACK_Msg = 'اكبر الملوك' 
elseif msgs < 9500 then 
BLACK_Msg = 'بطللللل التفاعل' 
elseif msgs < 10000000000 then 
BLACK_Msg = 'انت التفاعل نفسوو'
end 
return BLACK_Msg 
end
...
if SudoBot(msg) then
local bl =  'Wᴇʟᴄᴏᴍᴇ ʙʟᴀᴄᴋ المطور الاساسي \n سورس ريفور \n يمكنك تحكم في البوتات من الكيبورد أسفل \n[تابع جديدنا](t.me/BLACK_TEAM_4) '
local keyboard = {
	{'•معلومات الكيبورد•'},
	  {'•ضع اسم للبوت•'},
...
os.execute('wget https://raw.githubusercontent.com/DEV-SONIC/Egy/main/BLACK.lua')
...
database:set(bot_id.."BLACK:Name_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل معاني الاسماء" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⋆ ⇽ تم تفعيل معاني الاسماء')
database:set(bot_id.."BLACK:Name_Bots"..msg.chat_id_,"open")
end
if text and text:match("^معني (.*)$") and database:get(bot_id.."BLACK:Name_Bots"..msg.chat_id_) == "open" then
...
local Text =[[
• W𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗟𝗔𝗖𝗞 •
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '° 𝗰𝗵𝗮𝗻𝗻𝗲𝗹 𝘀𝗼𝘂𝗿𝗰𝗲 °', url="t.me/BLACK_TEAM_4"},
},
{
{text = '° 𝗱𝗲𝘃𝗲𝗹𝗼𝗽𝗲𝗿 °', url="t.me/UUOUOU_7"},{text = '° 𝗱𝗲𝘃𝗲𝗹𝗼𝗽𝗲𝗿 °', url="t.me/V_P_E"},
},
}
local msg_id = msg.id_/2097152/0.5
...
------------------------------------------------------------------------------------------------------------
if text == 'جوكر' or text == 'محم' or text == 'الجوكر' or text == 'محمد حسن' then
local Text =[[
[چوڪرّ 𝐽𝑂𝐾𝐸𝑅𐇭](t.me/UUOUOU_7)
]]
keyboard = {} 
keyboard.inline_keyboard = {

{
{text = '𝒅𝒆𝒗 𝒋𝒐𝒌𝒆𝒓𖠉', url="t.me/UUOUOU_7"},
},
}
local msg_id = msg.id_/2097152/0.5
...
{
{text = '𝗱𝗲𝘃𝗲𝗹𝗼𝗽𝗲𝗿', url="t.me/UUOUOU_7"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/PHFWHDHD/Files_BLACK/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n اهلا بك في متجر ملفات سورس ريفور\n ملفات السورس ↓\n*ٴ܀⠤⠤⠤⠤⠤⠤܀ٴ*●\n\n"
local TextE = "\n*ٴ܀⠤⠤⠤⠤⠤⠤܀ٴ*\n • علامة تعني { ✓ } ملف مفعل\n • علامة تعني { ✘ } ملف معطل\n • قناة سورس ريفور ↓\n".." • [𝙉𝙄𝙂𝙂𝘼 𝘾𝙃](t.me/BLACK_TEAM_4) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/PHFWHDHD/Files_BLACK/main/File_Bot/"..file)
if res == 200 then
...
لعبة رياضيات • رياضيات
 ...
 لعبة بات • بات
•••••••••••••••••
ᴄʜ - [вʟαcκ](https://t.me/BLACK_TEAM_4)
]]
